...
<img src="/images/legacy/taffy_sticky_js_postit.jpg" alt="Sticky Javascript Persistence" width="480" height="418" />
  
On my [last blog post](/a-more-elaborated-jquery-drag-drop-cloning/ "A more Elaborated jQuery Drag & Drop") I explained how to create a drag and drop using cloning, so you can can drag & drop multiple objects
