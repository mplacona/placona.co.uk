...
<!-- <p style="text-align: center;">
  <img src="/images/legacy/date_format_flex_flexdateformat.jpg" alt="Formatting dates with flex" width="480" height="276" /><br /> (Photo: <a title="Photo by adactio" rel="nofollow" href="https://www.flickr.com/photos/adactio/" target="_blank">adactio</a>)
</p> -->

I've been working with some [Adobe Flex](https://www.adobe.com/products/flex.html "Adobe Flex") recently, and was having some trouble formatting dates. For those who don't know, here (in th UK) we use the format "dd/mm/yyyy" (Day/Month/Year) as opposed to people over in the States using "mm/dd/yyyy" (Month/Day/Year).
  
I had to use the [DateField](https://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/mx/controls/DateField.html "Flex: Date Field Component") component, and couldn't find a way in heaven to get the date it returns formatted as "dd/mm/yyyy".
...
Damn it! Isn't there anything like [Coldfusion's DateFormat](https://help.adobe.com/en_US/ColdFusion/9.0/CFMLRef/WSc3ff6d0ea77859461172e0811cbec22c24-7ff4.html "ColdFusion Formatting Dates")?
...
Basically what you have to to, is use [mx:DateFormatter](https://help.adobe.com/en_US/FlashPlatform/reference/actionscript/3/mx/formatters/DateFormatter.html "Flex: Date Formatter"), and create your mask as such:
