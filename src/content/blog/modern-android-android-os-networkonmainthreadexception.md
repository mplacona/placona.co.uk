...
description: "Part of my Modern Android Development series: what causes android.os.NetworkOnMainThreadException and the right way to fix it today."
pubDate: "2020-03-15T16:38:42.000Z"
slug: "modern-android-android-os-networkonmainthreadexception"
categories: ["Android"]
tags: ["modern android development","android"]
image: "/images/2020/03/modern-android-android-os-networkonmainthreadexception-header.png"
draft: false
---


> This blog post is a part of a series that aims to fix the issue with too much inaccurate information out on the internet. It will focus on modern Android development. You can read more about the problem [here](/modern-android-development/).

Over the [last blog post](/modern-android-development/), I used an example of a StackOverflow question with over 80 answers where the answer marked as correct and with the most votes is no longer accurate.
